...
export const useFHECounter = (parameters: {
  ...
  const refreshCountHandle = useCallback(() => {
    ...
    thisFheCounterContract
      ...
      .then(value => {
        ...
        if (sameChain.current(thisChainId) && thisFheCounterAddress === fheCounterRef.current?.address) {
  ...
  const incOrDec = useCallback(
    ...
    [ethersSigner, fheCounter.address, fheCounter.abi, instance, chainId, refreshCountHandle, sameChain, sameSigner],
  );
